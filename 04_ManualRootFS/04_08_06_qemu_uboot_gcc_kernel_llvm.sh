#!/bin/bash
# 04_08_06_qemu_uboot_gcc_kernel_llvm.sh
# 配套04_06预处理脚本，方案1：Image内置rootfs单virtio磁盘
# 组合：GCC U-Boot + LLVM Kernel
set -e

echo "============================================="
echo "04_08_06_qemu_uboot_gcc_kernel_llvm.sh | GCC U-Boot + LLVM Kernel QEMU"
echo "============================================="
echo "脚本启动时间: $(date '+%Y-%m-%d %H:%M:%S')"
echo "============================================="

UBOOT_BIN="./output_gcc/uboot/u-boot.bin"
ROOTFS_IMG="./out_gcc_uboot_llvm_kernel/rootfs.ext4"
