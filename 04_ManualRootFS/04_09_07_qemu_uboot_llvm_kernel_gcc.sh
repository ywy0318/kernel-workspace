#!/bin/bash
# 04_09_07_qemu_uboot_llvm_kernel_gcc.sh
# 配套04_07预处理脚本｜方案2：双virtio磁盘，内核独立磁盘
# 组合：LLVM U-Boot + GCC Kernel
set -e

echo "============================================="
echo "04_09_07_qemu_uboot_llvm_kernel_gcc.sh | LLVM U-Boot + GCC Kernel QEMU(双磁盘方案2)"
echo "============================================="
echo "脚本启动时间: $(date '+%Y-%m-%d %H:%M:%S')"
echo "============================================="

UBOOT_BIN="./output_llvm/uboot/u-boot.bin"
ROOTFS_IMG="./build_uboot_kernel_pair_ubllvm_kerngcc/rootfs.ext4"
KERNEL_DISK="./build_uboot_kernel_pair_ubllvm_kerngcc/kernel_Image.raw"
