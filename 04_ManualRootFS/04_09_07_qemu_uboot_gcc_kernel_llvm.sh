#!/bin/bash
# 04_09_07_qemu_uboot_gcc_kernel_llvm.sh
# 配套04_07预处理脚本｜方案2：双virtio磁盘，内核独立磁盘
# 组合：GCC U-Boot + LLVM Kernel
set -e

echo "============================================="
echo "04_09_07_qemu_uboot_gcc_kernel_llvm.sh | GCC U-Boot + LLVM Kernel QEMU(双磁盘方案2)"
echo "============================================="
echo "脚本启动时间: $(date '+%Y-%m-%d %H:%M:%S')"
echo "============================================="

UBOOT_BIN="./output_gcc/uboot/u-boot.bin"
ROOTFS_IMG="./build_uboot_kernel_pair_ubgcc_kernllvm/rootfs.ext4"
KERNEL_DISK="./build_uboot_kernel_pair_ubgcc_kernllvm/kernel_Image.raw"
